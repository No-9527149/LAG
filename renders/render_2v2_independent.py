...
LastEditTime : 2024-11-12 17:23:41
FilePath     : /LAG/renders/render_2v2_independent.py
Description  : 
"""
...
ego_policy = PPOActor(
    args, env.observation_space, env.action_space, device=torch.device("cuda")
)
enm_policy = PPOActor(
    args,
    spaces.Box(low=-10, high=10.0, shape=(15,)),
    env.action_space,
