...
LastEditTime : 2024-11-11 18:04:49
FilePath     : /LAG/envs/JSBSim/core/render_tacview.py
Description  : 
"""
...
def data_replay(data):
    ...
    for time_step in range(len(data) + 2):
        ...
        if len(data[time_step]) == 36:
            show_tacview(
                display,
                sim_time=time_step / 12,
                state=data[time_step][:6],
                my_id="300001",
                name="F16",
                color="Blue",
            )
